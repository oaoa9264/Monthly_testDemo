package com.bwie.monthly_testdemo.Adapter;
...
import com.bwie.monthly_testdemo.Application.ImageUtils;
import com.bwie.monthly_testdemo.R;
...
public class Myadapter extends RecyclerView.Adapter {
    ...
    public Myadapter(Context context, List<Bean.DataBean> dataBeanList) {
        ...
        options = ImageUtils.initOptions();
    }
